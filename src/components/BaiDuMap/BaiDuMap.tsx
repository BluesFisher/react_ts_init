...
const BaiDuMap: React.FC<IProp> = (props: IProp) => {
    ...
    const onDocumentClick = (e: any) => {
        ...
        if (classList && Array.prototype.indexOf.call(classList, INPUT_CLASS) === -1 && Array.prototype.indexOf.call(classList, SEARCH_CLASS) === -1) {
        ...
        <BaseDialog isShowPop={props.isShowPop} isBackIcon={true} size={{ width: '9.56rem', height: '5.8rem' }} onCancel={onPopCancel}>
            <div className="map-pop-container">
                ...
                <div className="baidumap-container">
                    ...
                    <div id="baidumap-container">BaiDuMap</div>
                    <div className="map-search-container" style={{ display: searchDisplay }}>
                        {searchResult.map((item: any) => (
                            <div className="map-search-item" key={item.business} title={`${item.district} ${item.business}`} onClick={() => handleSearch(item)}>
                ...
                <button className="baidumap-confirm" onClick={onComfirm}>
                    确 认
                </button>
            </div>
        </BaseDialog>
