...
const BaseBarEchart: React.FC<IProps> = (propsIn: IProps) => {
    ...
    const drawChart = (chartData = props.chartData, optionIn = props.option): void => {
        ...
        const option: any = {
            ...
            grid: {
                left: 0.16 * rootFontSize * 5,
                top: 0.16 * rootFontSize * 2,
                right: 0.16 * rootFontSize * 5,
                bottom: 0.16 * rootFontSize * 5
            },
            xAxis: {
                data: dataAxis,
                axisLabel: {
    ...
    return (
        <div className="baseLineEchart-container">
            ...
            {props.chartData ? <div id={props.domId || domId} className="chart-content" /> : <div className="nodata-tip center-y center-x">{props.noneDataTips}</div>}
        </div>
    );
};
