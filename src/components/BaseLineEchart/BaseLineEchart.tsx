...
const BaseLineEchart: React.FC<IProps> = (propsIn: IProps) => {
            ...
            markLine.push({
                ...
                label: {
                    ...
                    rich: {
                        a: {
                            color: item.color,
                            padding: [0.3 * rootFontSize, 0, 0, -0.9 * rootFontSize]
                        }
                    }
                },
                yAxis: item.value
        ...
        const option: any = {
            tooltip: {
                ...
                formatter: (para: any) => {
                    ...
                    return typeof para[0].value !== 'undefined' ? `${chartData.date} ${time} ${chartData.selectPo}: ${para[0].value.toFixed(1)}` : '--';
                }
            },
            textStyle: {
    ...
    return (
        <div className="baseLineEchart-container">
            ...
            <div className="nodata-tip center-y center-x" style={{ display: props.chartData ? 'none' : 'block' }}>
                {props.noneDataTips}
            </div>
        </div>
    );
